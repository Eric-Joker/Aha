...
USER_CACHE = LRUCache(cfg.register("user_aha_id", 32768, _("identity.user.cache.cfg_comment"), "cache"))
GROUP_CACHE = LRUCache(cfg.register("group_aha_id", 256, _("identity.group.cache.cfg_comment"), "cache"))
