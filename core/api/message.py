...
class MessageAPI:
    ...
    @staticmethod
    async def send_msg(
        msg: str | list | dict = None, at: str | int = None, reply: str | int = None, image: str | Path = None
    ) -> str:
        """
        Args:
    ...
    @overload
    @staticmethod
    async def send_unescape_text(text: str) -> str:
        """发送不转义的文本消息。
    ...
    @overload
    @staticmethod
    async def send_forward_msg(forward: Forward) -> str:
        """发送合并转发消息。
    ...
    @overload
    @staticmethod
    async def send_forward_msg_by_id(messages: list[str | int]) -> str:
        """
        Returns:
            str: message_id
        """
    ...
    @overload
    @staticmethod
    async def send_unescape_text(*, user_id: str | int = None, group_id: str | int = None, text: str, bot: int = None) -> str:
    ...
    async def send_forward_msg(
        *, user_id: str | int = None, group_id: str | int = None, forward: Forward, bot: int = None
    ) -> str:
    ...
    async def send_forward_msg_by_id(
        *, user_id: str | int = None, group_id: str | int = None, messages: list[str | int], bot: int = None
    ) -> str:
        """若 `group_id` 有值则发送群聊消息，否则发送私聊消息。
    ...
    @staticmethod
    async def send_forward_msg(*, user_id=None, group_id=None, forward, bot=None) -> str:
        pass
    ...
    async def get_record(
        file: str = None, file_id: str = None, out_format: AudioFormat = AudioFormat.MP3, *, bot: int = None
    ) -> Record:
        """获取语音文件"""

    @staticmethod
    async def get_image(file: str = None, file_id: str = None, *, bot: int = None) -> Image:
        """获取图片文件"""
