...
class AccountAPI:
    ...
    @staticmethod
    async def set_online_status(status: int, ext_status: int, battary_status: int, *, bot: int = None):
        pass
    ...
    @staticmethod
    async def set_self_longnick(long_nick: str, *, bot: int = None):
        pass
    ...
    @staticmethod
    async def get_status(*, bot: int = None) -> AccountStatus:
        pass
    ...
    @staticmethod
    async def send_like(user_id: str | int, times: int = 1, *, bot: int = None):
        pass

    @staticmethod
    async def set_friend_add_request(flag: str, approve: bool, remark: str | None = None, *, bot: int = None):
        """设置通过好友请求
    ...
    @staticmethod
    async def get_friend_list(*, bot: int = None) -> list[Friend]:
        pass
    ...
    @staticmethod
    async def delete_friend(user_id: str | int, block: bool = True, both: bool = True, *, bot: int = None):
        """删除好友
        Args:
    ...
    @staticmethod
    async def get_recent_contact(*, bot: int = None) -> list[RecentContact]:
        pass
    ...
    # region 群
    @staticmethod
    async def ask_share_group(group_id: str | int, *, bot: int = None):
        pass
    ...
    @staticmethod
    async def get_card_by_search(user_id: str | int, group_id: str | int = None, force_return_card=False, *, bot: int = None) -> tuple[str | None, str] | str | None:
    ...
    @staticmethod
    async def fetch_custom_face(count: int = 48, *, bot: int = None) -> CustomFaceList:
        pass

    @staticmethod
    async def get_user_status(user_id: str | int, *, bot: int = None) -> UserAccount:
        pass
