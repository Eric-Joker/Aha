...
CACHE_FILE_DIR = cfg.register("cache_file_path", Path(os.path.abspath("cache")), _("file_cache.path_cfg_comment"), "cache")
CACHE_FILE_CLEANUP = cfg.register("file_cleanup", "0 4 * * *", _("file_cache.cleanup.cfg_comment"), "cache")
