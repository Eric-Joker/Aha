...
class SupportAPI:
    # region AI 声聊
    @staticmethod
    async def get_ai_characters(group_id: str | int, chat_type: Literal[1, 2], *, bot: int = None) -> AICharacterList:
        pass

    @staticmethod
    async def get_ai_record(group_id: str | int, character_id: str, text: str, *, bot: int = None) -> str:
        """
    ...
    @staticmethod
    async def can_send_record(group_id: str | int, *, bot: int = None) -> bool:
        pass
