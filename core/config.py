...
class Config(metaclass=SingletonMeta):
    ...
    def _dumps(cls, obj, parent: OptionCommentedMap | OptionCommentedSeq, index, type_map: dict):
        ...
        if isinstance(obj, aioPath):
            ...
            return str(obj)
        raise TypeError(_("config.type_convert.unsupported") % obj.__class__.__name__)
    ...
    def register[T: Any | Option](self, key, default: T = None, comment=None, module=None) -> T | None:
...
- 'process': Each API service runs in its own process, all module callbacks share a single thread.""",
    ...
    cfg.register("console_level", Option(getLevelNamesMapping(), "INFO"), "Console log level.", "log")
    cfg.register("file_level", Option(getLevelNamesMapping(), "AHA_DEBUG"), "File log level.", "log")
    cfg.register("max_files", 5, "Maximum number of log files.", "log")
    cfg.register("max_size", "16MiB", "Maximum size per log file.", "log")

    def init_base_cfgs():
        cfg.register("super", (User("QQ", "114514"),), "Super user ID.", "aha")
        cfg.register("global_msg_prefix", "~", _("config.comment.global_msg_prefix"), "aha")
        ...
        cfg.register("memory_level", Option(("low", "medium", "high"), "medium"), _("config.comment.memory_level"), "aha")
        ...
        cfg.register("debug", False, _("config.comment.debug"), "aha")
