...
def remove_str_msg_prefix(msg: str) -> str: ...
def remove_msg_seq_prefix(msg: MsgSeq) -> MsgSeq: ...
...
class PM(metaclass=PatternMatcherMeta):
    ...
    message_chain: FieldClause[MsgSeq]
    msg_list: FieldClause[MsgSeq]
    message_list: FieldClause[MsgSeq]
    message_chain: FieldClause[MsgSeq]
    message_seq: FieldClause[MsgSeq]
...
async def evaluate(
    msg: BaseEvent, expr: Expr | BoolExpr, token: int | None = None, pool: ExprPool | None = None
) -> bool | None: ...
