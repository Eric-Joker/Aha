...
class MessageAPI:
    ...
    @overload
    @staticmethod
    async def send_raw_msg(data) -> str:
        """发送不经过 Aha 处理的原始消息。
    ...
    @overload
    @staticmethod
    async def send_music(url: str, image: str | Path = None, audio: str = None, title: str = None, content: str = None) -> str:
        """发送音乐分享消息。
    ...
    @overload
    @staticmethod
    async def send_raw_msg(*, user_id: str | int = None, group_id: str | int = None, data, bot: int = None) -> str:
    ...
    @staticmethod
    async def get_reaction_users(message_id: str | int, emoji_id: str | int, *, bot: int = None) -> list[ReactionUser]:
        """获取指定回应的详情"""
